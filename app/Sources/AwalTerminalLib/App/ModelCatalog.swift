...
enum ModelCatalog {
    static let all: [LLMModel] = [
        ...
        LLMModel(name: "Kiro (PTY)", provider: "Amazon",         command: "kiro-cli chat",       configPath: nil,                             installCommand: "curl -fsSL https://kiro.dev/install | bash", contextWindow: 200_000, resumeCommand: "kiro-cli chat --resume", injectionStrategy: .none, dangerFlag: "--trust-all-tools", remoteControlFlag: nil, prefersACP: false),
