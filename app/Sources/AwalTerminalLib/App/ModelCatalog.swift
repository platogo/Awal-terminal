...
enum ModelCatalog {
    static let all: [LLMModel] = [
        ...
        LLMModel(name: "Kiro",     provider: "Amazon",          command: "kiro-cli chat",       configPath: nil,                             installCommand: "curl -fsSL https://kiro.dev/install | bash", contextWindow: 200_000, resumeCommand: "kiro-cli chat --resume", injectionStrategy: .instructionsFlag, dangerFlag: "--trust-all-tools", remoteControlFlag: nil),
